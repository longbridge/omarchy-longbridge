...
Red and green are reserved for rise/fall text, the sparklines that show the same movement, and the live dot. Icons, surfaces, selection, and borders remain theme-neutral; only the official logo in the panel header uses brand colors.
